...
namespace HotelApp
{
    ...
    internal class StandardRoom :Room
    {
        ...
        {
            return $"RoomNumber: {RoomNumber}, BedConfiguration: {BedConfiguration}, DailyRate: {DailyRate}, IsAvail: {IsAvail}, RequireWifi: {RequireWifi}, RequireBreakfast: {RequireBreakfast}";
        }
    }
}
